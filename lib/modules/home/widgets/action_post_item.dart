...
class ActionPostItem extends StatelessWidget {
  const ActionPostItem({super.key, this.iconString, this.count, this.onTap, this.color});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Row(
        children: [
          ImageIcon(AssetImage(iconString ?? AssetUtils.icoHome), color: color ?? Colors.white, size: 24),
